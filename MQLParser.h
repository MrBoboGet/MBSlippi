...
template<> inline int MBCC::GetTypeEnd<Literal_Base>(){return(30);}
...
template<> inline int MBCC::GetTypeBegin<Filter_Component_Base>(){return(31);}
template<> inline int MBCC::GetTypeEnd<Filter_Component_Base>(){return(35);}
