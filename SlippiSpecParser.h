...
template<> inline int MBCC::GetTypeBegin<FilterList>(){return(7);}
template<> inline int MBCC::GetTypeEnd<FilterList>(){return(8);}
...
template<> inline int MBCC::GetTypeBegin<Module>(){return(8);}
template<> inline int MBCC::GetTypeEnd<Module>(){return(9);}
template<> inline int MBCC::GetTypeBegin<Operator>(){return(9);}
template<> inline int MBCC::GetTypeEnd<Operator>(){return(10);}
template<> inline int MBCC::GetTypeBegin<GameSelection>(){return(10);}
template<> inline int MBCC::GetTypeEnd<GameSelection>(){return(11);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate_Conjunction>(){return(11);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate_Conjunction>(){return(12);}
template<> inline int MBCC::GetTypeBegin<AttributeComponent>(){return(12);}
template<> inline int MBCC::GetTypeEnd<AttributeComponent>(){return(13);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate_Data_Base>(){return(13);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate_Data_Base>(){return(16);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate_Variable>(){return(14);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate_Variable>(){return(15);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate_Direct>(){return(15);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate_Direct>(){return(16);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate>(){return(16);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate>(){return(17);}
template<> inline int MBCC::GetTypeBegin<GameInfoPredicate_OperatorList>(){return(17);}
template<> inline int MBCC::GetTypeEnd<GameInfoPredicate_OperatorList>(){return(18);}
template<> inline int MBCC::GetTypeBegin<PlayerAssignment>(){return(18);}
template<> inline int MBCC::GetTypeEnd<PlayerAssignment>(){return(19);}
template<> inline int MBCC::GetTypeBegin<Filter_ArgList>(){return(19);}
template<> inline int MBCC::GetTypeEnd<Filter_ArgList>(){return(20);}
template<> inline int MBCC::GetTypeBegin<Filter_Arg_Base>(){return(20);}
template<> inline int MBCC::GetTypeEnd<Filter_Arg_Base>(){return(23);}
template<> inline int MBCC::GetTypeBegin<Filter_Arg_Positional>(){return(21);}
template<> inline int MBCC::GetTypeEnd<Filter_Arg_Positional>(){return(22);}
template<> inline int MBCC::GetTypeBegin<Filter_Arg_Named>(){return(22);}
template<> inline int MBCC::GetTypeEnd<Filter_Arg_Named>(){return(23);}
template<> inline int MBCC::GetTypeBegin<ArgList>(){return(23);}
template<> inline int MBCC::GetTypeEnd<ArgList>(){return(24);}
template<> inline int MBCC::GetTypeBegin<AttributeList>(){return(24);}
template<> inline int MBCC::GetTypeEnd<AttributeList>(){return(25);}
template<> inline int MBCC::GetTypeBegin<Filter_Component_Data_Base>(){return(25);}
template<> inline int MBCC::GetTypeEnd<Filter_Component_Data_Base>(){return(28);}
template<> inline int MBCC::GetTypeBegin<Filter_Component_Variable>(){return(26);}
template<> inline int MBCC::GetTypeEnd<Filter_Component_Variable>(){return(27);}
template<> inline int MBCC::GetTypeBegin<Filter_Component_Function>(){return(27);}
template<> inline int MBCC::GetTypeEnd<Filter_Component_Function>(){return(28);}
template<> inline int MBCC::GetTypeBegin<Filter_Component>(){return(28);}
template<> inline int MBCC::GetTypeEnd<Filter_Component>(){return(29);}
template<> inline int MBCC::GetTypeBegin<Filter_OperatorList>(){return(29);}
template<> inline int MBCC::GetTypeEnd<Filter_OperatorList>(){return(30);}
template<> inline int MBCC::GetTypeBegin<Filter>(){return(30);}
template<> inline int MBCC::GetTypeEnd<Filter>(){return(31);}
template<> inline int MBCC::GetTypeBegin<Result_Base>(){return(31);}
template<> inline int MBCC::GetTypeEnd<Result_Base>(){return(35);}
template<> inline int MBCC::GetTypeBegin<Result_Record>(){return(32);}
template<> inline int MBCC::GetTypeEnd<Result_Record>(){return(33);}
template<> inline int MBCC::GetTypeBegin<Result_Print>(){return(33);}
template<> inline int MBCC::GetTypeEnd<Result_Print>(){return(34);}
template<> inline int MBCC::GetTypeBegin<Result_Tabulate>(){return(34);}
template<> inline int MBCC::GetTypeEnd<Result_Tabulate>(){return(35);}
